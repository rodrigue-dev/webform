<%@ Page Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="section.aspx.cs" Inherits="b_school.admin.section" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row container mb-2">
        <a class="btn btn-outline-dark" href="/admin/add_section">Ajouter un section</a>
    </div>
      <div class="row">
